    ...
    [
      "hr-resident-egs", {
        ...
        helpTextMap: {
          ...
          4: "Check if hospitalB is currently full: does it have the same number of residents as its available capacity?",
          5: "hospitalB's number of residents is equal to its max capacity, so choose the worst resident assigned to hospitalB",
          6: "Clear the match between hospitalB and resident2",
          7: "Assign resident1 to hospitalB",
          8: "placeholder 8",
          9: "placeholder 9",
          10: "placeholder 10",
          11: "placeholder 11",
